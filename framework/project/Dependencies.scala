...
object Dependencies {
  ...
  val runtime = Seq(
    ...
    "com.flipkart.phantom" % "runtime-netty-uds"	% "1.1.9" exclude("com.flipkart.phantom", "netty-uds"),
    "com.flipkart.phantom" % "netty-uds"	% "1.1.9" exclude("org.newsclub", "junixsocket"),
